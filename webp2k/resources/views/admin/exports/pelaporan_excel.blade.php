<table>
    <thead>
        <tr>
            <th colspan="4" style="text-align: center; font-weight: bold; font-size: 14px;">REKAPITULASI KUNJUNGAN PER AO</th>
        </tr>
        <tr>
            <th colspan="4" style="text-align: center;">Periode: {{ $tglAwal }} - {{ $tglAkhir }}</th>
        </tr>
    </thead>
    <tbody>
        @foreach($data_ao as $ao)
            ...
            <tr style="background-color: #e3f2fd;">
                ...
                <td colspan="3" style="font-weight: bold; border: 1px solid #000;">{{ $ao->nama }} ({{ $ao->kode_ao }})</td>
            </tr>
            ...
            <tr>
                ...
                <td style="border: 1px solid #000; text-align: center;">{{ $nasabah->tanggal }}</td>
            ...
            <tr style="font-weight: bold; background-color: #fff9c4;">
                <td colspan="3" style="border: 1px solid #000; text-align: right;">Total Kunjungan {{ $ao->nama_karyawan }}:</td>
