<div class="page-title" style="margin-bottom: 25px;">
    ...
    <p style="font-size: 14px; font-weight: 600;">
        <span onclick="loadAdminPage('dashboard')" style="cursor: pointer; color: #000; transition: 0.2s;" onmouseover="this.style.color='#007bff'" onmouseout="this.style.color='#000'">
            Dashboard
        </span> 
